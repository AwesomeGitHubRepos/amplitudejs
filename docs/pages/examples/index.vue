<template>
    <div class="w-full h-screen flex items-start">
        ...
        <div class="prose prose-invert prose-p:text-[#CECFD2] px-4 md:px-0 w-full pt-6 md:w-[calc(100%-256px)] lg:w-[calc(100%-448px)] md:pt-6 pb-10 h-screen no-scrollbar overflow-y-auto">
